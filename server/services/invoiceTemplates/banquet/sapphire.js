...
const rows = (items, taxed = true) => items.map((it, i) => `
  <tr>
    <td class="c">${i + 1}</td>
...
<body><div class="page">
  ...
  <table>
    <thead><tr><th class="c">#</th><th>Description</th><th class="n">Qty</th><th class="n">Rate</th>${taxed ? '<th class="n">GST</th>' : ''}<th class="n">Amount</th></tr></thead>
