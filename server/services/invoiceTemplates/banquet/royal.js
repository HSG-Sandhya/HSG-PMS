...
<style>
  *{box-sizing:border-box;margin:0;padding:0}
  ...
  .frame{border:2px solid #cbb06a;padding:36px 42px;position:relative}
  ...
  .crest{width:60px;height:60px;margin:0 auto 12px;border-radius:50%;border:2px solid #cbb06a;display:flex;align-items:center;justify-content:center;color:#a8862f;font-family:'Cormorant Garamond',serif;font-size:30px;background:#fbf7ec;overflow:hidden}
  .crest img{width:100%;height:100%;object-fit:contain;border-radius:50%}
  .eyebrow{font-size:10px;letter-spacing:.42em;text-transform:uppercase;color:#a8862f;margin-bottom:6px}
  .hname{font-family:'Cormorant Garamond',serif;font-size:32px;font-weight:600;color:#2f2a22;letter-spacing:.02em;line-height:1.1}
  .hmeta{font-size:11px;color:#8c8168;margin-top:10px;line-height:1.7}
  .rule{display:flex;align-items:center;justify-content:center;gap:12px;margin:16px 0 2px}
  ...
  .card{border:1px solid #e7dcc2;background:#faf5e8;border-radius:4px;padding:16px 18px}
  ...
  .card .ln{font-size:12px;color:#8c8168;line-height:1.8;margin-top:5px}
  ...
  thead th{font-family:'Cormorant Garamond',serif;font-size:14px;color:#a8862f;text-align:left;padding:12px 10px;border-top:2px solid #cbb06a;border-bottom:1px solid #cbb06a;letter-spacing:.05em}
  thead th.n{text-align:right}
  tbody td{padding:13px 10px;border-bottom:1px solid #ece1c8;font-size:13px;vertical-align:top}
  ...
  .words{background:#faf5e8;padding:14px 18px;border-left:2px solid #cbb06a;font-size:12px;color:#8c8168;font-style:italic}
  ...
  .sum .r{display:flex;justify-content:space-between;padding:9px 0;font-size:13px;color:#8c8168;border-bottom:1px solid #ece1c8}
  ...
  .sign{text-align:center;margin-top:26px;padding-top:20px;border-top:1px solid #e7dcc2;color:#8c8168;font-size:11px}
