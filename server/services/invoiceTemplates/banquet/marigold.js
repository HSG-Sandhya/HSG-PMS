...
<style>
  *{box-sizing:border-box;margin:0;padding:0}
  ...
  .inner{border:1px solid #e0b558;padding:34px 40px}
  .hdr{text-align:center;padding-bottom:20px;position:relative}
  .hdr::after{content:'';display:block;height:3px;margin-top:18px;background:repeating-linear-gradient(90deg,#c9992f 0,#c9992f 10px,transparent 10px,transparent 18px)}
  .om{font-size:16px;color:#c0392b;letter-spacing:.4em}
  .logo{width:58px;height:58px;margin:8px auto 10px;border-radius:50%;border:2px solid #d4a017;display:flex;align-items:center;justify-content:center;color:#c0392b;font-family:'Marcellus',serif;font-size:26px;overflow:hidden}
  .logo img{width:100%;height:100%;object-fit:contain;border-radius:50%}
  .hname{font-family:'Marcellus',serif;font-size:32px;color:#8c2d1a;letter-spacing:.02em}
  .hmeta{font-size:11px;color:#9a6b46;margin-top:8px;line-height:1.7}
  ...
  .title .no{font-size:12px;letter-spacing:.16em;color:#9a6b46;margin-top:10px}
  ...
  .card{border:1px solid #eccf8f;border-radius:8px;padding:16px 18px;background:#fff8ea}
  ...
  .card .ln{font-size:12px;color:#9a6b46;line-height:1.7;margin-top:4px}
  ...
  thead th{background:#8c2d1a;color:#ffe6b8;font-family:'Marcellus',serif;font-size:13px;text-align:left;padding:11px 10px;letter-spacing:.04em}
  thead th.n{text-align:right}
  tbody td{padding:13px 10px;border-bottom:1px solid #f0dcb4;font-size:13px;vertical-align:top}
  ...
  .foot{display:grid;grid-template-columns:1fr .9fr;gap:22px;margin-top:20px}
  .words{background:#fff3dc;border:1px solid #eccf8f;border-radius:8px;padding:14px 18px;font-size:12px;color:#9a6b46}
  .words strong{display:block;font-family:'Marcellus',serif;color:#8c2d1a;font-size:14px;margin-top:4px}
  .sum .r{display:flex;justify-content:space-between;padding:9px 0;font-size:13px;color:#9a6b46;border-bottom:1px solid #f0dcb4}
  ...
  .end{text-align:center;margin-top:22px;padding-top:18px;border-top:3px double #c9992f;color:#9a6b46;font-size:11px}
